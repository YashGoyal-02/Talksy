...
function SideBar() {
  ...
  return (
    <div className={`lg:w-[30%] w-full h-full lg:block bg-slate-200 ${!selectedUser?"block":"hidden"}`}>
      <div className='w-[60px] h-[60px] mt-[10px] bg-[#20c7ff] rounded-full overflow-hidden flex justify-center items-center shadow-gray-500 shadow-lg fixed bottom-[20px] left-[10px] text-gray-700' onClick={handleLogOut}>
      ...
      <div className="w-full h-[300px] bg-[#20c7ff] rounded-b-[30%] shadow-gray-400 shadow-lg flex flex-col justify-center px-[20px]">
        ...
        <div className='w-full flex items-center gap-[20px]'>
          ...
          {search && <form className='w-full h-[60px] bg-white shadow-gray-500 shadow-lg flex items-center gap-[10px] mt-[10px] rounded-full overflow-hidden px-[20px]'>
            ...
            <input type="text" placeholder='search users...' className='w-full h-full p-[10px] border-0 outline-none text-[17px]'/>

            <RxCross2 className='w-[25px] h-[25px] cursor-pointer' onClick={()=>setSearch(false)}/>
            </form>}
            {!search && otherUsers?.map((user)=>{
              return (
              <div className='w-[60px] h-[60px] mt-[10px] rounded-full overflow-hidden flex justify-center items-center shadow-gray-500 shadow-lg bg-white'>
  ...
  {otherUsers?.map((user) => (
    <div 
      ...
      <div className='w-[60px] h-[60px] rounded-full overflow-hidden flex justify-center items-center shadow-gray-500 shadow-lg bg-white'>
        <img src={user.image ? user.image : dp} alt="" className='h-[100%]' />
      </div>
